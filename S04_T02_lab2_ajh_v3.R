...
## you can combine the packages using c() function.
...
names(aindresp)
## Summary statistics of the data: min, max, mean, quantiles
summary(aindresp)
...
## We can add the variables into the table by specifying deparse.level=2
...
## 4.08% are male and do not like their neighborhood
## 46.2% are female and like their neighborhood
## 5.32% are female and do not like their neighborhood

## In order to get percentages within each group, we use "filter" (sex==1 is for males)
...
ggpredict(wge.margins, terms = c("sex [Male]","married [1]","quals [1]"))
ggpredict(wge.margins, terms = c("sex [Male]","married [0]","quals [1]"))
ggpredict(wge.margins, terms = c("sex [Male]","married [1]","quals [0]"))
ggpredict(wge.margins, terms = c("sex [Male]","married [0]","quals [0]"))
...
## If we would like to see several regressions results in a nice looking table
