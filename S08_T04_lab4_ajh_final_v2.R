...
install.packages(c("tidyverse", "naniar", "haven", "survey", "labelled","Rmisc","expss","ggplot2", "AER","estimatr","margins","ggeffects","ivreg", "plm", "stargazer","htmltools"))
...
packages <-c("tidyverse","naniar", "haven", "survey", "labelled","Rmisc","expss","ggplot2", "AER","estimatr","margins","ggeffects","ivreg", "plm", "stargazer","htmltools")
...
table(df$ivfio, df$region2, deparse.level = 2, useNA = "ifany") 
...
Rmisc::summarySE(df, measurevar = "paych", na.rm = T)
